    ...
    <ThreadPrimitive.Root className="flex h-full min-h-0 flex-col overflow-hidden">
      ...
      <div className="flex shrink-0 items-center gap-2 border-b border-border px-4 py-2.5">
        ...
        <button
          type="button"
          onClick={onClose}
          className="rounded p-1 text-muted hover:text-foreground hover:bg-surface-alt transition-colors"
      ...
      {/* Viewport — this is the only scrollable area */}
      <ThreadPrimitive.Viewport className="flex min-h-0 flex-1 flex-col overflow-y-auto px-4">
        <div className="flex min-h-0 flex-1 flex-col">
          ...
          {/* Scroll to bottom — positioned in the chat area */}
          <div className="pointer-events-none sticky bottom-[4.5rem] z-20 flex w-full justify-center pb-1">
        ...
        {/* Composer — sticky at bottom of viewport */}
        <ThreadPrimitive.ViewportFooter className="sticky bottom-0 z-10 shrink-0 border-t border-border bg-surface pt-3 pb-3">
